...
if(isset($_POST['view'])){
  ...
  //$student_amount = mysqli_num_rows($students);
...
<section class="col-md-12" style="margin-top: 10px;">
      ...
      <div class="col-md-12">
          <form method="POST" action="results.php">
              ...
              <div class="form-group col-lg-2">
                <input type="" name="exam_year" class="form-control" id="" value="" placeholder="Exam Year" required>
              </div>
  ...
  <div class="col-md-12 <?php echo $form ;?>">
      <div class="center text-center">
          <h4><?php echo $year?>  <?php echo $semester?> Semester ( <?php echo $exam_year?> )</h4>
      </div>
      <br>
